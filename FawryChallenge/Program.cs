...
namespace FawryChallenge
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Product cheese = new Product() { Name="Cheese",Price=225,ProductQuantity=2,IsShipabble=true,Weight=420,ExpirationDate= DateTime.Now.AddDays(1)};
            ...
            CheckoutService checkout1 = new CheckoutService(shippingService);
